...
(function() {
  'use strict';
  angular.module('niblApp', ['ngAnimate', 'ngCookies', 'ngResource', 'ngRoute', 'ngSanitize', 'ngTouch', 'ui.bootstrap', 'restangular', 'ngTagsInput', 'toaster']).config(function($interpolateProvider) {
