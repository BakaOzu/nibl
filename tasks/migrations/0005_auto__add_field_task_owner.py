...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tasks_task', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='tasks', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.owner'
        db.delete_column(u'tasks_task', 'owner_id')
