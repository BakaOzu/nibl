...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tasks_project', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='projects', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.owner'
        db.delete_column(u'tasks_project', 'owner_id')
